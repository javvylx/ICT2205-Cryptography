...
#define SC_MENU "test1"
#define ZARA_MENU "test2"
#define UNI_MENU "TEST"
#define MF_MENU "TEST"
#define WT_MENU "TEST"
...
char* retr_request(int n, char* target){
	...
	else if(strcmp(target,"https://app.mediafire.com")==0){
		char request[2][256] = {"GET / HTTP/1.1\r\nHost: app.mediafire.com\r\n\r\n", "test"};
		strncpy(buff, request[n-1], sizeof(request[n-1]));
	}
	else if(strcmp(target,"https://www.wetransfer.com")==0){
...
char* retr_menu(int n){
	...
	case 2: return UNI_MENU;
	case 3: return MF_MENU;
	case 4: return WT_MENU;
