...
#define ZARA_MENU "Please choose a number accordingly. Option 1 & 2 are sample requests, to prove the script is working.\n1) GET - Homepage\n2) POST - Add to cart function\n3) Custom request (Manually enter request)\n0) Return to main menu\nOption: "
#define UNI_MENU "Please choose a number accordingly. Option 1 & 2 are sample requests, to prove the script is working.\n1) GET - Homepage\n2) POST - Add to cart function\n3) Custom request (Manually enter request)\n0) Return to main menu\nOption: "
//modify
#define MF_MENU "Please choose a number accordingly. Option 1 & 2 are sample requests, to prove the script is working.\n1) GET - Homepage\n2) POST - Add to cart function\n3) Custom request (Manually enter request)\n0) Return to main menu\nOption: "
//Modify
#define WT_MENU "Please choose a number accordingly. Option 1 & 2 are sample requests, to prove the script is working.\n1) GET - Homepage\n2) POST - Add to cart function\n3) Custom request (Manually enter request)\n0) Return to main menu\nOption: "
